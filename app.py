...
def total_flight_bar():
    ...
    title="Total Flights by Airport (2013 - 2018)",
    text="arr_flights",
)
    return json.dumps(fig6, cls=plotly.utils.PlotlyJSONEncoder)
...
def performance():
    ...
    return render_template("performance.html", fig4=fig4)
